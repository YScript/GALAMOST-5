...
from gamst.forces import potentials
...
def dihedral_force(cu_func_pro, cu_func_imp):
	...
	if not isinstance(cu_func_pro, cuda.compiler.DeviceFunctionTemplate) or not isinstance(cu_func_imp, cuda.compiler.DeviceFunctionTemplate):
