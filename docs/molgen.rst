...
The initial configuration of simulation systems could be generated by employing a plugin of GALAMOST (named **molgen**, the abbreviation of "molecule generator").
The format of output files could be MST, Mol2 or XML.

The **molgen** need be compiled by GCC (GNU Compiler Collection). 
