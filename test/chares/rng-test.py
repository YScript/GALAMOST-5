'''
GAMST - GPU-Accelerated Molecular Simulation Toolkit
COPYRIGHT
	GAMST Copyright (c) (2020) You-Liang Zhu
LICENSE
...
DISCLAIMER
	The authors of GAMST do not guarantee that this program and its 
...
USER OBLIGATION 
	If any results obtained with GAMST are published in the scientific 
