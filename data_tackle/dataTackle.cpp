...
int main(int argc,char* argv[])
	...
	cout<<"19 MST conversion      20 patch/spot display 21 SSF               "<<endl;
	...
	for(unsigned int i=0;i<command.size();i++)
		...
		switch(command[i])
			...
			case 9:
				...
				cout<<"9.  Computing the image for unfolding molecules and output to '*.reimage.mst' files"<<endl;
			...
			case 19:
				{
				shared_ptr<MSTfileConversion> mst_file_conversion = shared_ptr<MSTfileConversion>(new MSTfileConversion());
				object.push_back(mst_file_conversion);
				cout<<"19.  MST file conversion"<<endl;
