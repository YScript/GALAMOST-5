...
molgen_module = Extension(name='molgen',  # 模块名称
                           sources=['DNAchain.cpp',  'Molecule.cpp', 'Protein.cpp', 'Object.cpp', 'Generators.cpp', 'MolgenModule.cpp', 'mst_reader.cpp'],    # 源码
                           include_dirs=[pybind11.get_include()],     # 依赖的第三方库的头文件
						   extra_compile_args=['-std=c++11']
                           )

setup(ext_modules=[molgen_module],zip_safe=True,name='molgen', version='0.1')
